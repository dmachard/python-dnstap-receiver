...
class TestTcpSocket(unittest.TestCase):
    def test1_listening(self):
        ...
        cmd = 'python3 -c "from dnstap_receiver.receiver import start_receiver; start_receiver()" -v'
    ...
    def test2_incoming_dnstap(self):
        ...
        cmd = 'python3 -c "from dnstap_receiver.receiver import start_receiver; start_receiver()"'
